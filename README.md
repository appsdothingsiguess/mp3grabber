...
- Install CUDA Toolkit 13.x from [NVIDIA CUDA Downloads](https://developer.nvidia.com/cuda-downloads)
...
- `nvidia-cublas` (optional) - CUDA linear algebra library (auto-detects CUDA version)
- `nvidia-cudnn-cu13` (optional) - CUDA deep neural network library for CUDA 13 (use `nvidia-cudnn-cu12` for CUDA 12)
...
# For CUDA 13, use version-specific package nvidia-cudnn-cu13
pip install nvidia-cublas nvidia-cudnn-cu13
# For CUDA 12, use: pip install nvidia-cublas nvidia-cudnn-cu12
